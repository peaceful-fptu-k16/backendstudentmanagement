...
from app.schemas import CrawlRequest, GenerateReportRequest
...
async def crawl_website(
    ...
    try:
        ...
        # Generate comprehensive report with Excel and 12 charts
            ...
            "preview": [
                {
                    ...
                    "literature_score": s.literature_score,
...
async def generate_report_from_url(
    ...
    """Generate comprehensive report by crawling HTML from provided URL"""
